...
export class ClientsComponent implements AfterViewInit {
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(ClientDialogContentComponent, {
      data: obj,
    });
...
export class ClientDialogContentComponent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClientDialogContentComponent>,
